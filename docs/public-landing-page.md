# StegLearn Public Landing Page Source

> Publication source for the future StegVerse.org StegLearn informational landing page.
>
> This document describes product intent and implemented source posture. It does not claim production activation, classroom deployment, partnership, accreditation, credentialing authority, or runtime evidence that has not been observed.
...
## Begin by enhancing the human teacher

The preferred initial implementation is **human teacher + governed StegLearn AI Entity**.

StegLearn is designed to work alongside human educators before attempting more autonomous learning contexts.

A governed AI Entity can be visibly present in the learning environment, interact with learners, use explicitly authorized sensors and learning signals to evaluate engagement, participation, responsiveness, activity, and progress, and help the teacher adapt instruction in real time.
...
-> better-preserved learning evidence
```

## A governed AI participant in the learning environment

StegLearn is not intended to be only a hidden AI service behind a dashboard.

The StegLearn Entity is designed to appear on-screen and participate in the learning process. When authorized, it may speak, listen, present material, guide activities, support individuals or small groups, and use permitted sensor and learning inputs to help understand what is happening across the learning environment.

That can include observable variables such as:

- participation in discussion or activity;
- response timing and interaction cadence;
- progress through a task or experiment;
- repeated requests for clarification or repetition;
- changes in activity during instruction;
- questions asked, attempts made, and revisions completed;
- teacher-entered observations and participant-created artifacts.

Technical access to a sensor does not automatically make its use admissible. Sensor and learning inputs must be explicitly permitted for the context in which they are used.

## Curriculum from entry level through research depth

StegLearn should not force every participant into a fixed catalog or a single sequence.

A participant may ask to learn something at an appropriate depth such as:

- orientation or first exposure;
- foundational literacy;
- beginner;
- intermediate;
- advanced;
- vocational or applied professional;
- undergraduate-equivalent;
- graduate or master's-equivalent;
- doctoral or research-equivalent;
- post-doctoral or frontier specialization, where applicable.

These labels describe instructional depth and rigor. They are not, by themselves, degrees, licenses, accreditation, or institutional credentials.

StegLearn can develop a curriculum containing prerequisites, objectives, conceptual sequence, readings, exercises, projects, experiments, formative checks, research questions, evidence expectations, specialization branches, and completion criteria.
...
It can assist the teacher by helping surface:

- who has and has not participated;
- where several learners are encountering the same difficulty;
- which activities appear stalled or complete;
- where a different explanation, example, or pace may help;
- which questions or revisions should be preserved;
- where a learner may be ready for a deeper branch;
- where prerequisite work may be useful;
- where the teacher's direct attention may be most valuable.

The teacher decides what to do with that information.

## Bounded delegation

A teacher may explicitly delegate a limited activity to StegLearn while remaining responsible for the educational context.
...
The broader product model is participant-relative rather than human-only.
...
StegLearn is built around a principle:
...
Underneath live teaching and curriculum adaptation is a learning-evidence loop:
...
A learning receipt can preserve what the participant asked, attempted, observed, explained, revised, built, demonstrated, or discovered, together with the applicable teacher, parent, steward, or other admitted review.
...
- support a learner, pair, small group, or separately admitted participant;
- organize evidence;
- suggest next steps;
...
The teacher-first model creates a governed path toward broader use:
...
-> individually admitted governed learning
-> more autonomous governed learning where separately admitted
```

Later autonomy is not automatically authorized simply because an earlier form of assistance worked.
...
**What becomes possible when that same AI Entity enhances a human teacher rather than replacing one?**
...
StegLearn is designed to evaluate and interact with external educational systems only through explicit governed boundaries.
